...
MODEL_POST_IMAGE_DIR = MODEL_TOP_DIR + 'post_gray_rotate_crop/'
...
print('out_img_batch.shape ', out_img_batch.shape)

# Crop the image using api
#out_img = nd.image.crop(out_img_batch[0], x=0, y=500, width=200, height=200) 
...
#plt.imsave(a_file_name, out_img_batch[0].asnumpy(), cmap='Greys')
#plt.imsave(a_file_name, out_img_batch[0].asnumpy(), cmap='gray')
plt.imsave(a_file_name, out_img.asnumpy(), cmap='gray')
