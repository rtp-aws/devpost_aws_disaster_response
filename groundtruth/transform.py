...
#job_name = 'labeling-job/icy-bridge-daylight-vs-night-time-clone-clone'
job_name = 'icy-bridge-daylight-vs-night-time-clone-clone'

#ground_truth_manifest_file should be set to the name of your existing manifest file, including the relative path.
ground_truth_manifest_file = 'output.manifest'
